<template>
  <div>
    ...
    <!-- 1 -->
    <div class="lg:flex lg:flex-row lg:pt-5">
      <div class="basis-1/12"></div>
      <!-- Picture -->
      <div
        class="basis-6/12 h-0 lg:mx-0 lg:h-auto bg-[url('../assets/introImg1.jpeg')] rounded-xl bg-cover bg-center mx-24"
      ></div>
      <div class="basis-1/12"></div>
      <!-- Word -->
      <div class="basis-6/12 align-middle px-20 py-3 lg:p-0">
        ...
        >
          ...
          và chống bụi tuyệt đối.
        </div>
        <div
          class="lg:hidden mx-3 h-[300px] bg-[url('../assets/introImg1.jpeg')] bg-cover bg-center max-w-full rounded-xl"
        ></div>
      </div>
      <div class="basis-1/12"></div>
    </div>
    <!-- 2 -->
    <div class="lg:flex lg:flex-row lg:pt-16">
      <div class="basis-1/12"></div>
      <!-- Word -->
      ...
      <!-- Picture -->
      <div
        class="basis-6/12 lg:mx-0 bg-[url('../assets/crew.jpeg')] bg-cover max-w-full lg:h-[300px] h-[400px] mx-24 rounded-xl"
      ></div>
      <div class="basis-1/12"></div>
    </div>
  </div>
